...
export default class Game2048 {
    ...
    constructor(gridSize?: number, score?: number, grid?: number[][], gameOver?: boolean) {
    ...
    private slideAndCombine(row: number[]): number[] {
    ...
    private transpose(grid: number[][]): number[][] {
